---
name: review
description: "Weekly review: score the week, pick one system change"
---
...
1. Run the vault's `graph-audit` script on every touched durable file, including every created or reconstructed
   content artifact.
