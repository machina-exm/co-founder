...
loaded from `references/CONVENTIONS-core.md` (in this skill's own folder — from the terminal it is `${HERMES_SKILL_DIR}/references/CONVENTIONS-core.md`). Every page created here carries the
