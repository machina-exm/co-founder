---
name: steward
description: "Vault upkeep: capture new lessons, audit and prune"
---
...
Before choosing a mode, read `references/CONVENTIONS-core.md` (in this skill's own folder — from the terminal it is `${HERMES_SKILL_DIR}/references/CONVENTIONS-core.md`). This resolves from
...
1. Capture mode runs the vault's `graph-audit` script with every touched durable file. Health mode runs it
