---
name: help
description: "Which /co-founder skill fits the current situation."
---
...
Read `references/CONVENTIONS-core.md` (in this skill's own folder — from the terminal it is `${HERMES_SKILL_DIR}/references/CONVENTIONS-core.md`) and apply its Help exception. A Ready system
