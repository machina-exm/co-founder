...
Read `references/CONVENTIONS-core.md`, then look for the charter (AGENTS.md /
...
- **Partial mode** (some structure exists): name what is missing, stop and run the co-founder-setup skill before anything else in re-sync mode, and run the gauntlet verbally if the founder wants to
