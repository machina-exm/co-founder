...
Partial, or Wrong-folder result stops and runs the co-founder-setup skill before anything else (re-sync for Partial), without writing a review. On Ready, read the charter and path map.
