...
Read `references/CONVENTIONS-core.md` and apply its Help exception. A Ready system
...
Any Fresh, Partial, or Wrong-folder result stops and runs the co-founder-setup skill before anything else (re-sync for Partial).
